...
<?php $id=$this->input->get('route'); $date = R::isoDateTime(); $this->load->view('admin/menu/logistik/function/f_permintaan');?>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card card-loading">
                    ...
                    <div class="card-body p-0">
                        <ul class="nav nav-pills flex-column">
                            <li class="nav-item">
                                <span onclick="$.get_menu('\admin-menu-logistik-html-h_frm_penerimaan')"
                                    class="btn nav-link text-left mn-1">
                                    <i class="fas fa-fw fa-warehouse"></i> Form Penerimaan
                                    <span class="badge bg-primary float-right">0</span>
                                </span>
                            </li>
                            <li class="nav-item">
                                <span onclick="$.get_menu('\admin-menu-logistik-html-h_frm_permintaan')"
                                    class="btn nav-link text-left mn-2">
                                    <i class="fas fa-fw fa-clipboard-check"></i> Data Permintaan
                                    <span class="badge bg-primary float-right">0</span>
                                </span>
                            </li>
                        </ul>
            ...
            <div class="col-md-9 load-view-menu">
                <?php $this->load->view("admin/menu/logistik/html/h_frm_penerimaan");?>
            </div>
        </div>
    </div>
</section>