...
<?php $id=$this->input->get('route'); $date = R::isoDateTime(); $this->load->view('admin/menu/logistik/function/f_penjualan');?>
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card card-loading">
                    ...
                    <div class="card-body p-0">
                        <ul class="nav nav-pills flex-column">
                            <li class="nav-item">
                                <span onclick="$.get_menu('\admin-menu-logistik-html-h_frm_penjualan')"
                                    class="btn nav-link text-left mn-1">
                                    <i class="fas fa-fw fa-clipboard-check"></i>Data Penjualan
                                    <span class="badge bg-primary float-right">0</span>
                                </span>
                            </li>
                            <li class="nav-item">
                                <span onclick="$.get_menu('\admin-menu-kasir-html-h_frm_data_transaksi')"
                                    class="btn nav-link text-left mn-2">
                                    <i class="fas fa-fw fa-cash-register"></i>Data Transaksi
                                    <span class="badge bg-primary float-right">0</span>
                                </span>
                            </li>
                            <li class="nav-item">
                                <span onclick="$.get_menu('\admin-menu-kasir-html-h_frm_data_initial')"
                                    class="btn nav-link text-left mn-3">
                                    <i class="fas fa-fw fa-exclamation"></i> Data Initial
                                    <span class="badge bg-primary float-right">0</span>
                                </span>
                            </li>
                        </ul>
            ...
            <div class="col-md-10 load-view-menu">
                <?php $this->load->view("admin/menu/logistik/html/h_frm_penjualan");?>
            </div>
        </div>
    </div>
</section>