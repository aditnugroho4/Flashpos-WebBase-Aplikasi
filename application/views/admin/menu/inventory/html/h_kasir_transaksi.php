                            ...
                            <div class="row">
                                    ...
                                    <div class="card card-outline card-brown">
                                        ...
                                        <div class="card-body">
                                            <div class="input-group input-group-lg">
                                                ...
                                                <button class="btn btn-app bg-brown"><i class="fas fa-print"></i>
                                                    Reprint</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="card card-outline card-brown">
                                        ...
                                        <div class="card-body overflow-auto " style="max-height:140px;">
                                            <div class="col-lg-12">
                                        ...
                                        <div class="card-footer">
                                            <div class="input-group input-group-lg">
                                                ...
                                                <div class="input-group-append">
                                                    <button class="input-group-text btn bg-brown"><i
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12 overflow-auto load-data-items"
                                                    style="min-height:475px;max-height:475px;">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 text-sm">
                <div class="card card-outline card-brown">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive scroll-bar rounded" style="max-height:350px;min-height:350px;">
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <button type="button" id="btn-cancel-bayar" class="btn btn-brown mb-2 col-12">
                                        <i class="fas fa-download"></i> CANCEL
                                    </button>
                                </div>
                                <div class=" col-xs-12 col-lg-8">
                                    <button type="button" id="btn-bayar" class="btn btn-brown col-12"><i
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input id="txtTotalbayar" type="text" disabled="disabled" onfocus="$.format_text(this);"
                                    class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="txtTotalItems">Total Item's</label>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group btn-group-lg text-center">
                                    <label class="btn btn-app mr-2 bg-info">
                                        ...
                                        <input type="checkbox" name="C-bayar" id="btn-cash" value="cash" required>
                                        Cash
                                    </label>
                                    <label class="btn btn-app mr-2 bg-info">
                                        <i class='far fa-credit-card'></i>
                                        <input type="checkbox" name="C-bayar" value="debet" id="btn-debet"> Debet
                                    </label>
                                    <label class="btn btn-app mr-2 bg-info">
                                        <i class='far fa-money-bill-alt'></i>
                                        <input type="checkbox" name="C-bayar" value="epay" id="btn-epay"> E-Pay
                                    </label>
                                </div>
                            </div>
                            <div class="txtCash">
                            ...
                            <div class="txtEpay">
                                <div class="form-group">
                                    ...
                                    <select name="cmbJenisEpay" id="cmbJenisEpay" class="form-control">
                                ...
                                <div class="form-group">
                                    <label for="txtEpay">Jumlah Bayar</label>
