...
$(document).ready(function() {
    ...
    $("#tblData1").dataTable({
        ...
        "sAjaxSource": "<?php echo site_url('admin/get_data_table_source'); ?>?table=t_jenis_aduan&columns=,nama,m_unit.name,unit_id&jwhere=unit_id&fildjoins=,m_unit.name&joins=m_unit&exports=m_unit",
        "aoColumns": [{
                "sTitle": "#",
                "mData": "no",
                "bSortable": false,
