        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box btn mn-1 btn-outline-secondary"
                    onclick="$.get_menu('\admin-menu-applikasi-html-h_buat_aduan')">
                    <span class="info-box-icon bg-info"><i class="fas fa-bullhorn"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">Buat Pengaduan</span>
                        <span
                            class="info-box-number"><?= R::count('t_data_pengaduan','status IS NULL AND user_id=?',array($user->id))?></span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box btn mn-2 btn-outline-secondary"
                    onclick="$.get_menu('\admin-menu-applikasi-html-h_status_aduan')">
                    <span class="info-box-icon bg-danger"><i class="far fa-calendar-check"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">Status Pengaduan</span>
                        <span
                            class="info-box-number"><?= R::count('t_data_pengaduan','status="K" OR status="S" AND user_id=?',array($user->id))?></span>
                    </div>
                    <div class=" info-box-more">
                        <button class="btn btn-sm btn-warning"><i class="fas fa-clock"></i>
                            <?= R::count('t_data_pengaduan','status="P" OR status="Y" AND user_id=?',array($user->id))?></button>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-12">
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box btn mn-4 btn-outline-secondary"
                    onclick="$.get_menu('\admin-menu-applikasi-html-h_arsiparis')">
