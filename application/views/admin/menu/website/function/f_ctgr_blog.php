...
$(document).ready(function() {
    ...
    $("#tblData").dataTable({
        ...
        "sAjaxSource": "<?php echo site_url('admin/get_data_table_source'); ?>?table=w_post_ctgr_blog&columns=,name",
        "aoColumns": [{
                "sTitle": "#",
                "mData": "no",
                "bSortable": false,
            ...
            },
            {
                ...
                "fnCreatedCell": function(nTd, sData, oData, iRow, iCol) {
                    ...
                    $(nTd).attr("id", id);
                    $(nTd).editable(
                        "<?php echo site_url('admin/update_grid/w_post_ctgr_blog'); ?>", {
    ...
    $("#add-data").submit(function(e) {
        ...
        if ($('#add-data').valid()) {
            ...
            $.ajax({
                type: "POST",
                dataType: 'json',
                url: "<?php echo site_url('admin/create/w_post_ctgr_blog'); ?>",
                data: {
                    name: $("#txtName").val()
                },
