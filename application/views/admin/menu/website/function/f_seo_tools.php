            ...
            },
            {
                ...
                "fnCreatedCell": function(nTd, sData, oData, iRow, iCol) {
                    ...
                    if (oData.icon == null) {
                        ...
                        htmlx =
                            "<div class='from-group thumbnail'><img class='img-thumbnail'width='65' height='65' src='<?= base_url(); ?>" +
                            oData.icon + "' alt='' ></div>";
                        $(nTd).html(htmlx);
                    }
                }
                ...
                "fnCreatedCell": function(nTd, sData, oData, iRow, iCol) {
                    $(nTd).html(
                        "<button class='btn btn-xs bg-green'><i class='fas fa-check'></i> Edit</button>"
                    );
            ...
            success: function(data) {
                ...
                if (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        HtmL += '<url>\n' +
                            '<loc><?php echo base_url('blog/detail/');?>' + data[i].id +
                            '/' + data[i].short_link + '</loc>\n' +
