<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); $this->load->view('admin/menu/website/function/f_web_submenu'); ?>
<div class="col-md-12">
            ...
            <div class=" card-tools">
                <div class="mailbox-controls">
                    <button type="button" id="btnAddSub" class="btn btn-default bg-pink btn-sm" data-toggle="tooltip"
                        data-placement="top" title="Tambah Sub Menu"><i class="fas fa-plus-circle"></i></button>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 col-xs-12 col-lg-6">
                                    ...
                                    <div class="form-group ">
                                        <label for="txtPatch_e">Patch Html</label>
                                        <div class="input-group">
                                            <input type="text" id="txtPatch_e"
                                                onfocus="$.queryLength(this,'#cnt-pau_e');" maxlength="250"
                                                placeholder="portal/menu/content/.." class="form-control " required>
                                        </div>
                                        <span class="float-right"><i id="cnt-au_e">0</i> : 250 characters</span>
                                    </div>
                                    <div class="form-group ">
                                        <label for="txtUrl_e">Url Controller</label>
                                        <div class="input-group">
                                            <input type="text" id="txtUrl_e"
                                                onfocus="$.queryLength(this,'#cnt-ctrl_e');" maxlength="25"
                                                placeholder="{blog}" class="form-control " required>
                                        </div>
                                        <span class="float-right"><i id="cnt-ctrl_e">0</i> : 25 characters</span>
                                    </div>
                                </div>
                            </div>
                        </div>
