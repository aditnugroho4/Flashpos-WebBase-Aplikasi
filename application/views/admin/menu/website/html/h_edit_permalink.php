...
<?php $this->load->view('admin/menu/website/function/f_edit_permalink'); ?>

<div id="dlg-add_permalink" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true" class="modal fade">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtNamaLink" placeholder="ex.: WhatsApp"
                                            class="form-control" maxlength="50" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="txtPermalink">Permalink</label>
                                        <input type="text" id="txtPermalink" placeholder="ex.: https://akbargrup.id/"
...
<div id="dlg-setting_permalink" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true"
    class="modal fade">
...
<div id="dlgDecision" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true" class="modal fade">
