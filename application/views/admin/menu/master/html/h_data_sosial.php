...
<?php $this->load->view('admin/menu/master/function/f_data_sosial');?>
<div class="col-md-12">
            ...
            <div class="card load-prof">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#Data-List" data-toggle="tab">Data Sosial</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="#Add-Data" data-toggle="tab">Tambah Data</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="#Edit-Data" data-toggle="tab">Edit Data</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body ">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="txtPendidikan" maxlength="50"
                                                        class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="txtPangkat" maxlength="10"
                                                        class="form-control" required>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label>Jabatan</label>
                                                    <input type="text" id="txtJabatan" maxlength="20"
                                                        class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                        ...
                        <div class="tab-pane" id="Edit-Data">
                            <form class="form-horizontal" id="edit-data-prof">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputUserName" disabled="true"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" maxlength="16" id="inputWhatsapp"
