...
<?php $id=$this->input->get('route'); $date = R::isoDateTime(); $this->load->view('admin/menu/kasir/function/f_promosi_kasir');?>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item">Promosi Kasir</li>
                </ol>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <div class="card card-loading">
                    <div class="card-header">
                        <h3 class="card-title">Master Promosi</h3>
