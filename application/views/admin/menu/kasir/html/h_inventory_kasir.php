...
<?php $id=$this->input->get('route'); $date = R::isoDateTime(); $this->load->view('admin/menu/kasir/function/f_inventory_kasir');?>
<section class="content-header">
    <div class="container-fluid">
        <!-- Breadcrumb -->
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Inventory Kasir</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url();?>">Home</a></li>
                    <li class="breadcrumb-item">Inventory Kasir</li>
                </ol>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2">
                ...
                <div class="card card-loading">
                    <div class="card-header">
                        <h3 class="card-title">Master Permintaan</h3>
                    ...
                    <div class="card-body p-0">
                        <ul class="nav nav-pills flex-column">
                            <li class="nav-item">
                                <span onclick="$.get_menu('\admin-menu-kasir-html-h_frm_permintaan')"
                                    class="btn nav-link text-left mn-1">
                                    <i class="fas fa-fw fa-clipboard-check"></i>Form Permintaan
                            ...
                            <li class="nav-item">
                                <span onclick="$.get_menu('\admin-menu-kasir-html-h_frm_history')"
                                    ...
                                    <i class="fas fa-fw fa-warehouse"></i> History
                                    <span class="badge bg-primary float-right">0</span>
                                </span>
                            </li>
                        </ul>
            ...
            <div class="col-md-10 load-view-menu">
                <?php $this->load->view("admin/menu/kasir/html/h_frm_permintaan");?>
            </div>
        </div>
    </div>
</section>