...
<?php $id=$this->input->get('route'); $date = R::isoDateTime(); $this->load->view('admin/menu/kasir/function/f_stock_kasir');?>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item">Stock Kasir</li>
                </ol>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card card-loading">
                    ...
                    <div class="card-body p-0">
                        <ul class="nav nav-pills flex-column">
                            <li class="nav-item">
                                <span onclick="$.get_menu('\admin-menu-kasir-html-h_frm_mutasi_stock')"
                                    class="btn nav-link text-left mn-1">
                                    <i class="fas fa-fw fa-clipboard-check"></i>Mutasi Stock
                                    <span class="badge bg-primary float-right">0</span>
                                </span>
                            </li>
                            <li class="nav-item">
                                <span onclick="$.get_menu('\admin-menu-kasir-html-h_frm_stock_berjalan')"
                                    class="btn nav-link text-left mn-2">
                                    <i class="fas fa-fw fa-warehouse"></i> Stock Berjalan
                                    <span class="badge bg-primary float-right">0</span>
                                </span>
                            </li>
                        </ul>
            ...
            <div class="col-md-10 load-view-menu">
                <?php $this->load->view("admin/menu/kasir/html/h_frm_mutasi_stock");?>
            </div>
        </div>
    </div>
</section>