...
<?php $id=$this->input->get('route'); $date = R::isoDateTime(); $this->load->view('admin/menu/kasir/function/f_penjualan_kasir');?>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card card-loading">
                    ...
                    <div class="card-body p-0">
                        <ul class="nav nav-pills flex-column">
                            <li class="nav-item">
                                <span onclick="$.get_menu('\admin-menu-kasir-html-h_frm_penjualan')"
            ...
            <div class="col-md-10 load-view-menu">
                <?php $this->load->view("admin/menu/kasir/html/h_frm_penjualan");?>
            </div>
        </div>
    </div>
</section>