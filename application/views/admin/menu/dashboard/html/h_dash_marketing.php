...
<?php $this->load->view('admin/menu/dashboard/function/f_dash_marketing'); ?>
            ...
            <div class="col-lg-12 mt-2">
                <div class="card card-outline card-purple">
                    <div class="justify-content-center text-center">
                        <img width="180" class="p-4" src="<?= base_url()?>asset/admin/dist/img/icon-2.png"
                            alt="Logo RSUDL">
                        <h1>SELAMAT DATANG</h1>
                        <h3><?php if($unit){echo($unit['name']);}else{echo("Data Penempatan Anda Bekerja Belum Lengkap <button id='btn-lengkap-posisi' class='btn btn-sm btn-warning'><i class='fas fa-exclamation'></i> Lengkapi</button>");}?>
                        </h3>
                    </div>
                </div>
            </div>
