...
$this->load->view('portal/menu/product/function/f_blog_detail');
?>
...
<section id="berita" class="home-section paddingtop-40">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <article class="artikel artikel-post">
                    ...
                    <div class="artikel-body">
                        <ul class="artikel-info">
                            <li class="artikel-category"><a href="#"><?=$Seo['Blogs']['Kategory']; ?></a></li>
                            <li class="artikel-type"><i class="far fa-copy"></i></li>
                        </ul>
                        <h1 class="artikel-title"><?=$Seo['Blogs']['Judul'];?></h1>
                        <ul class="artikel-meta">
                            <li><i class="fa fa-clock"></i> <?=$Seo['Blogs']['Date']; ?></li>
                            <li><i class="fa fa-comments"></i> ( <?=$Seo['Blogs']['Comment']; ?> )</li>
                            <li><i class="fa fa-eye"></i> ( <?=$Seo['data']['view'] ?> )</li>
                        </ul>
                        <?=$Seo['Blogs']['Content']?>
                    </div>
                    <div class="artikel-footer">
                        <?php if($Seo['Blogs']['Quote'] !=null || $Seo['Blogs']['Quote'] !='-'){ ?>
                        <div class="blog__quote">
                            <span>“</span>
                            <p><?=$Seo['Blogs']['Quote']; ?></p><span>“</span>
                        </div><?php }?>
                    </div>
                </article>
            ...
            <div class="col-md-4">
                ...
                <div class="aside-widget">
                    <div class="section-title">
                        <h2 class="title">Katagori Populer</h2>
                    </div>
